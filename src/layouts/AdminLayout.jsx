...
const ICONS = {
  ...
  users:
    "M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2M23 21v-2a4 4 0 00-3-3.87M16 3.13a4 4 0 010 7.75M9 11a4 4 0 100-8 4 4 0 000 8z",
        ...
        >
          <div
            style={{
              ...
              border: "1.5px solid rgba(197,97,44,0.4)",
              display: "flex",
              alignItems: "center",
              justifyContent: "center",
              flexShrink: 0,
          ...
          >
            {profile?.avatar_url ? (
              ...
              <span style={{ fontSize: 10, fontWeight: 700, color: "#C5612C" }}>
                {initials}
              </span>
            )}
          </div>
...
function AdminTopbar({ onMobileMenu }) {
  ...
  const timeStr = time.toLocaleTimeString("en-KE", {
    hour: "2-digit",
    minute: "2-digit",
    second: "2-digit",
    hour12: false,
  });
  const dateStr = time.toLocaleDateString("en-KE", {
    weekday: "short",
    month: "short",
    day: "numeric",
  });
    ...
    <>
      ...
      >
        ...
        <div style={{ display: "flex", flex: 1, overflow: "hidden" }}>
          ...
          {mobileOpen && (
            <div
              className="admin-mob-sidebar admin-drawer-enter"
              style={{
                position: "fixed",
                top: 0,
                left: 0,
