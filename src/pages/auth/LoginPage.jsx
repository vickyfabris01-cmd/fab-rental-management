    ...
    >
      ...
      <div
        ...
        style={{
          ...
          overflow: "hidden",
          background:
            "linear-gradient(150deg,#C5612C 0%,#8B3A18 45%,#3D1A0A 100%)",
        }}
      >
        <div
          style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
          {[
            ...
            },
            {
              icon: "✅",
              title: "Rent Paid",
              sub: "KES 8,500 via M-Pesa",
              badge: "Paid",
              bc: "rgba(16,185,129,0.25)",
              btext: "#6EE7B7",
            },
            {
              icon: "💬",
              title: "Complaint Resolved",
              sub: "Water issue fixed today",
              badge: "Done",
