...
const PropertyDetailPage = lazy(
  () => import("../pages/public/PropertyDetailPage.jsx"),
);
...
const AcceptInvitePage = lazy(
  () => import("../pages/auth/AcceptInvitePage.jsx"),
);
...
const TransferRequestPage = lazy(
  () => import("../pages/client/TransferRequestPage.jsx"),
);
const ClientComplaintsPage = lazy(
  () => import("../pages/client/ClientComplaintsPage.jsx"),
);
const ComplaintDetailPage = lazy(
  () => import("../pages/client/ComplaintDetailPage.jsx"),
);
const NotificationsPage = lazy(
  () => import("../pages/client/NotificationsPage.jsx"),
);
const ClientProfilePage = lazy(
  () => import("../pages/client/ClientProfilePage.jsx"),
);

// ── Manager ───────────────────────────────────────────────────────────────────
const ManagerDashboard = lazy(
  () => import("../pages/manager/ManagerDashboard.jsx"),
);
const PropertiesPage = lazy(
  () => import("../pages/manager/PropertiesPage.jsx"),
);
// ResidentsPage.jsx exports 4 components as named exports
const ResidentsPage = lazy(() =>
  import("../pages/manager/ResidentsPage.jsx").then((m) => ({
...
const RentalRequestsPage = lazy(() =>
  import("../pages/manager/ResidentsPage.jsx").then((m) => ({
    default: m.RentalRequestsPage,
  })),
);
const TenanciesPage = lazy(() =>
  import("../pages/manager/ResidentsPage.jsx").then((m) => ({
    default: m.TenanciesPage,
  })),
);
const ManagerBillingPage = lazy(
  () => import("../pages/manager/ManagerBillingPage.jsx"),
);
const ManagerPaymentsPage = lazy(
  () => import("../pages/manager/ManagerPaymentsPage.jsx"),
);
...
const WorkerSalariesPage = lazy(
  () => import("../pages/manager/WorkerSalariesPage.jsx"),
);
const AttendancePage = lazy(
  () => import("../pages/manager/AttendancePage.jsx"),
);
const ManagerComplaintsPage = lazy(
  () => import("../pages/manager/ManagerComplaintsPage.jsx"),
);
const AnnouncementsPage = lazy(
  () => import("../pages/manager/AnnouncementsPage.jsx"),
);
const ManagerSettingsPage = lazy(
  () => import("../pages/manager/ManagerSettingsPage.jsx"),
);
const ManagerProfilePage = lazy(
  () => import("../pages/manager/ManagerProfilePage.jsx"),
);

// ── Owner ─────────────────────────────────────────────────────────────────────
const OwnerDashboard = lazy(() => import("../pages/owner/OwnerDashboard.jsx"));
const OccupancyReportPage = lazy(
  () => import("../pages/owner/OccupancyReportPage.jsx"),
);
const FinancialSummaryPage = lazy(
  () => import("../pages/owner/FinancialSummaryPage.jsx"),
);
const OwnerBillingPage = lazy(
  () => import("../pages/owner/OwnerBillingPage.jsx"),
);
const WorkerCostsPage = lazy(
  () => import("../pages/owner/WorkerCostsPage.jsx"),
);
const OwnerAnalyticsPage = lazy(
  () => import("../pages/owner/AnalyticsPage.jsx"),
);
const OwnerProfilePage = lazy(
  () => import("../pages/owner/OwnerProfilePage.jsx"),
);

// ── Worker ────────────────────────────────────────────────────────────────────
const WorkerDashboard = lazy(
  () => import("../pages/worker/WorkerDashboard.jsx"),
);
const WorkerPaymentsPage = lazy(
  () => import("../pages/worker/WorkerPaymentsPage.jsx"),
);
const WorkerAttendancePage = lazy(
  () => import("../pages/worker/WorkerAttendancePage.jsx"),
);
const WorkerProfilePage = lazy(
  () => import("../pages/worker/WorkerProfilePage.jsx"),
);

// ── Super Admin ───────────────────────────────────────────────────────────────
const SuperAdminDashboard = lazy(
  () => import("../pages/admin/SuperAdminDashboard.jsx"),
);
const AdminTenantsPage = lazy(
  () => import("../pages/admin/AdminTenantsPage.jsx"),
);
const TenantDetailPage = lazy(
  () => import("../pages/admin/TenantDetailPage.jsx"),
);
const AdminUsersPage = lazy(() => import("../pages/admin/AdminUsersPage.jsx"));
const AdminRevenuePage = lazy(
  () => import("../pages/admin/AdminRevenuePage.jsx"),
);
const AdminAnalyticsPage = lazy(
  () => import("../pages/admin/AdminAnalyticsPage.jsx"),
);
  ...
  useEffect(() => {
    ...
    if (!meta) {
      ...
      for (const param of paramPatterns) {
        ...
        if (ROUTE_META[stripped]) {
          meta = ROUTE_META[stripped];
          break;
        }
      }
    }

    document.title = meta?.title ? `${meta.title} — fabRentals` : "fabRentals";
  }, [location.pathname]);
...
function AppLoader() {
  ...
  const subscribeNotifs = useNotificationStore(
    (s) => s.subscribeToNotifications,
  );
  const unsubscribeNotifs = useNotificationStore(
